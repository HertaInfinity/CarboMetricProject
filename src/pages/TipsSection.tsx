...
import { Lightbulb, RefreshCw, BookOpen, Leaf, Star, TrendingUp, Share2, Heart } from 'lucide-react';
  ...
  const tips = [
    {
      ...
      impact: '15% electricity reduction',
      co2_saved: 2.3,
      difficulty: 'Easy',
      time: '5 min',
      likes: 234,
    ...
    },
    {
      ...
      description: 'For trips under 3km, walking or cycling can save significant emissions while improving your health.',
      impact: '3.2kg CO₂ per trip',
      co2_saved: 3.2,
      difficulty: 'Easy',
      time: '0 min',
      likes: 189,
    ...
    },
    {
      ...
      description: 'Reducing meat consumption by one day per week can significantly lower your carbon footprint.',
      impact: '8kg CO₂ per week',
      co2_saved: 8.0,
      difficulty: 'Medium',
      time: '30 min',
      likes: 312,
    ...
    },
    {
      ...
      description: 'A single reusable bottle can replace hundreds of plastic bottles per year.',
      impact: '1.5kg CO₂ per month',
      co2_saved: 1.5,
      difficulty: 'Easy',
      time: '1 min',
      likes: 156,
    ...
    },
    {
      ...
      description: 'Local products require less transportation, reducing their carbon footprint significantly.',
    ...
    },
    {
      ...
      description: 'Electronics consume energy even when turned off. Unplugging can save 5-10% on electricity.',
      impact: '8% electricity reduction',
      co2_saved: 1.8,
      difficulty: 'Easy',
      time: '2 min',
      likes: 201,
    ...
    },
    {
      ...
      description: 'Public transport can reduce your carbon footprint by up to 85% compared to driving alone.',
      impact: '85% transport emission cut',
      co2_saved: 5.5,
      difficulty: 'Medium',
      time: '15 min',
      likes: 287,
    ...
    },
    {
      ...
      description: 'Plan meals and store food properly to reduce waste. Food waste contributes to methane emissions.',
      impact: '3kg CO₂ per week',
      co2_saved: 3.0,
      difficulty: 'Medium',
      time: '20 min',
      likes: 176,
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {tips.filter(tip => tip.featured).slice(0, 3).map((tip) => (
                <div key={tip.id} className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl p-6 hover:border-green-400/50 transition-all duration-300">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-2">
                      <Star className="w-5 h-5 text-yellow-400" />
                      <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getDifficultyColor(tip.difficulty)}`}>
                        {tip.difficulty}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${
                          likedTips.includes(tip.id) ? 'text-red-400' : 'text-gray-400 hover:text-red-400'
                        }`}
                      >
                        <Heart className={`w-4 h-4 ${likedTips.includes(tip.id) ? 'fill-current' : ''}`} />
                      </button>
                      <span className="text-gray-400 text-sm">{tip.likes}</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredTips.map((tip) => (
              <div key={tip.id} className="bg-gray-900/50 border border-gray-700 rounded-2xl p-6 hover:border-gray-600 transition-all duration-300 group">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
        ...
        <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-2xl p-8">
          <div className="text-center">
            ...
            <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-xl hover:from-purple-400 hover:to-pink-400 transition-all duration-300 transform hover:scale-105">
              Accept Challenge
            </button>
          </div>
        </div>
